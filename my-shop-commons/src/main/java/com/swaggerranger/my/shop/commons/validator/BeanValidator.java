package com.swaggerranger.my.shop.commons.validator;
 ...
 *
 * 只有写了一个方法其它都是复制过来的，validator--使用验证也是使用这个方法
 */
public class BeanValidator {

//    @Autowired,这里是个静态的属性不是类，所以在前面就不能用@注入，属性在spring-context.xml中单独配置
